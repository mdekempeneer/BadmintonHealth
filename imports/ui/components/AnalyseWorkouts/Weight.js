...
const type = 'HKQuantityTypeIdentifierWeight';
...
export default class Weight extends TrackerReact(Component) {
    constructor(props) {
        super(props)
