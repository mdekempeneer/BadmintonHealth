...
const type = 'senseTraining';
const type2 = 'sickHealth';
const type3 = 'pain';
const type4 = 'trainingScore';
...
export default class TrainingFeeling extends TrackerReact(Component) {
    ...
    render() {
        ...
        if(this.props.year) {
            data = {
                datasets: [{
                    label: i18n.__('badges.sense_training'),
                    fill: false,
                    lineTension: 0.3,
                    ...
                    label: i18n.__('badges.sick_health_training'),
                    fill: false,
                    lineTension: 0.3,
                    ...
                    label: i18n.__('badges.pain_training'),
                    fill: false,
                    lineTension: 0.3,
                    ...
                    label: i18n.__('badges.score_training'),
                    fill: false,
                    lineTension: 0.3,
