...
class HeartrateInputMax extends TrackerReact(Component) {
    constructor(props) {
        super(props);
    ...
    clickAdd(event) {
        if (this.state.heartrate === '') {
            ...
            if (check1 || check2) {
                ...
                Meteor.call('addHeartRateMax', number, 'max', points, () => {
                    levelChecker();
                    badgeChecker();
                });
            }
...
export default withStyles(styles)(HeartrateInputMax);
